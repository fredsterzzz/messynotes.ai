...
export default defineConfig({
  ...
  define: {
    ...
    'process.env.VITE_STRIPE_PRO_PRICE_ID': JSON.stringify(process.env.VITE_STRIPE_PRO_PRICE_ID),
    'process.env.VITE_STRIPE_ENTERPRISE_PRICE_ID': JSON.stringify(process.env.VITE_STRIPE_ENTERPRISE_PRICE_ID),
